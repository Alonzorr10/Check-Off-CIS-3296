        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-lg leading-4 font-medium rounded-md text-stone-500 dark:text-stone-400 bg-white dark:bg-stone-800 hover:text-stone-700 dark:hover:text-stone-300 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-stone-200 dark:border-stone-600">
            <div class="px-4">
                ...
                <div class="font-medium text-lg text-stone-500">{{ Auth::user()->email }}</div>
            </div>
